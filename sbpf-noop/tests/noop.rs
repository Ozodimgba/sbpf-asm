...
mod tests {
    ...
    fn setup_test_context() -> (Mollusk, Pubkey, Account) {
        ...
        let mollusk = Mollusk::new(&program_id, "deploy/noop");
...
fn test_noop_success() {
    ...
    #[test]
    fn test_noop_with_no_accounts() {
        let (mollusk, program_id, _) = setup_test_context();
